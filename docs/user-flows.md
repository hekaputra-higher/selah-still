...
Errors: authentication failure leaves form open; save failure retains all writing; journal failure offers refresh. Network errors must never be shown as successful saves.
